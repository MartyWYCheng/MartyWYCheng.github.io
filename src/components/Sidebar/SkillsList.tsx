...
export function SkillsList() {
  ...
  return (
    <div className="relative">
      ...
      <aside className={`sidebar transition-all duration-300 ${isCollapsed ? 'hidden md:block' : 'block'} md:w-64 sticky top-0 h-screen overflow-y-auto bg-custom-gray pt-16 p-6 space-y-6`}>
        {!isCollapsed && (
          <>
